...
$options[] = array(
			"name" => __('Disable Sticky Sidebar','truethemes_localize'),
			"desc" => __('The Sidebar and Side-Nav pages have a sticky sidebar that stays in place while the page is scrolled. <em>Un-check this box to disable this functionality.</em>','truethemes_localize'),
...
$options[] = array(
			"name" => __('Mobile Menu - Hide Subpages','truethemes_localize'),
			"desc" => __('Check this box to hide subpages in the Mobile Menu. Un-checking this box will display all menu items in a long list.','truethemes_localize'),
...
$options[] = array(
			"name" => __('(7) Dropdown Menu - Link Hover Background Color','truethemes_localize'),
...
$options[] = array(
			"name" => __('(7) Footer - Link Color','truethemes_localize'),
...
$options[] = array(
			"name" => __('Footer - Transparent Overlay - Custom Image','truethemes_localize'),
...
$options[] = array(
			"name" => __('Footer - Back-to-top Link','truethemes_localize'),
			"desc" => __('A smooth scrolling animated back-to-top link. Un-check the box to disable.','truethemes_localize'),
			"id"   => $shortname."_scrolltoplink",
			"std"  => "true",
			"type" => "checkbox");
			
/* @since 4.6 - replaced with animated scroll-arrow button
...
$options[] = array(
			"name" => __('Footer Copyright','truethemes_localize'),
			"desc" => __('Display a copyright notice in the bottom left of the footer. Un-check the box to disable.','truethemes_localize'),
...
$options[] = array(
			"name" => __('Page Title Bar','truethemes_localize'),
			"desc" => __('The Page Title Bar is displayed at the top of each page. Un-check the box to disable.','truethemes_localize'),
...
$options[] = array(
			...
			"desc" => __('Breadcrumbs are included in the Page Title Bar. Un-check the box to disable.','truethemes_localize'),
...
$options[] = array(
			...
			"desc" => __('A Search box is included in the Page Title Bar. Un-check the box to disable.','truethemes_localize'),
