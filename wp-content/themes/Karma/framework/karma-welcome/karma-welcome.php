...
<div class="karma_welcome-feature karma-feature-section col three-col">
	...
	<div>
		...
		<p><a href="<?php echo esc_attr( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ) ?>" target="_blank">Install Plugins</a></p>
	</div>
	...
	<div>
		...
		<p><a href="<?php echo esc_attr( admin_url( 'themes.php?page=karma_theme_demo_content_generator' ) ) ?>" target="_blank">Import Demo Content</a></p>
	</div>
	...
	<div class="last-feature">
		...
		<p><a href="<?php echo esc_attr( admin_url( 'themes.php?page=siteoptions' ) ) ?>" target="_blank">Appearance > Site Options</a></p>
	</div>
...
<div style="width: 44%;float:left;">
	<br /><br />
	<h2 style="line-height:15px;"><span class="dashicons dashicons-format-video" style="margin-right:5px;"></span> Training Videos</h2>
	<p>A complete set of instructional training videos to learn every aspect of using the Karma theme.</p>
	<p><a href="http://vimeopro.com/truethemes/karma-4" target="_blank">Training Videos</a></p>
</div>

<div style="width: 44%;float:right;">
	<br /><br />
	<h2 style="line-height:15px;"><span class="dashicons dashicons-admin-users" style="margin-right:5px;"></span> Support</h2>
...
<div style="width: 70%;float:left;">
	<br /><br />
	<h2 style="line-height:15px;"><span class="dashicons dashicons-editor-help"  style="margin-right:5px;"></span> Did you know</h2>
