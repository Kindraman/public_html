...
array(
	...
	'type'     => 'multicheck',
	'options'  => array(
		'true' => __('Check this box to <strong>disable</strong> this page\'s Page Title Bar (breadcrumbs, search bar, etc)','truethemes_localize'),
	)
),

array(
	'name' => __('Page Title','truethemes_localize'),
	'desc' => __('Override the Page Title displayed in the Page Title Bar.','truethemes_localize'),
	'id'   => '_pagetitle_value',
	'type' => 'text_medium',
),
