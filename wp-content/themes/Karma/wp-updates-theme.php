...
new WPUpdatesThemeUpdater_1451( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1451') ) {
    class WPUpdatesThemeUpdater_1451 {
