...
class OptionsCollection implements \ArrayAccess {
  ...
  public function getButtonIcon() {
    ...
    if($this->options['button_image'] && $this->options['button_image']->getValue())
      return '<img src="' . $this->options['button_image'] .'" class="responsive-menu-pro-button-icon responsive-menu-pro-button-icon-active" />';
    else
  ...
  public function getButtonIconActive() {
    ...
    if($this->options['button_image'] && $this->options['button_image']->getValue())
      return '<img src="' . $this->options['button_image_when_clicked'] .'" class=" responsive-menu-pro-button-icon responsive-menu-pro-button-icon-inactive" />';
  }
