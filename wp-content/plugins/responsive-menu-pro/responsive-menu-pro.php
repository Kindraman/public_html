...
add_action('plugins_loaded', function() {
  load_plugin_textdomain('responsive-menu-pro', false, basename(dirname(__FILE__)) . '/translations/');
});

/* Route the plugin */
$wp_router = new ResponsiveMenuPro\Routing\WpRouting($container);
$wp_router->route();
...
if(is_admin()):
  ...
  // Setup Updater
  $updater = new ResponsiveMenuPro\Licensing\Check('https://responsive.menu', __FILE__, [
  ...
  add_action('plugins_loaded', function() use($container) {
    if(function_exists('pll_register_string')):
      ...
      pll_register_string('Menu Slug', $menu_to_use, 'Responsive Menu Pro');
      pll_register_string('Button Title', $button_title, 'Responsive Menu Pro');
      pll_register_string('Menu Title', $menu_title, 'Responsive Menu Pro');
      pll_register_string('Menu Title Link', $menu_title_link, 'Responsive Menu Pro');
    endif;
  });
